...
安装脚本支持的操作系统/环境矩阵可参考：[`docs/zh/installer-support.md`](./docs/zh/installer-support.md)
...
详细的 Railway 图文部署指南，请阅读：👉 **[Railway 完整部署指南 / railway-deployment.md](./docs/en/railway-deployment.md)**
...
有关平台部署、线上生存指南、故障排除以及测试验收的完整手册，都请参阅 [`/docs`](./docs/) 文件夹（英文文档：[`docs/en/`](./docs/en/)，中文文档：[`docs/zh/`](./docs/zh/)）。
