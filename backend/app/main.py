...
from app.api.mc import router as mc_router
...
async def lifespan(_: FastAPI) -> AsyncIterator[None]:
    ...
    # Run seed if needed
    try:
        from app.seed_mc import seed
        await seed()
    except Exception as e:
        logger.warning("Seed skipped: %s", e)
    # Start background sync
    from app.services.data_sync import start_sync_loop
...
api_v1.include_router(mc_router)
