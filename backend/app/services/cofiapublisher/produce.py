...
def execute_vip(voice_id=None) -> dict:
    ...
    beats = [
        ...
        {"t": "Il n'a aucun plan, aucun risque défini, et aucune vraie raison d'entrer. Il a juste de l'espoir. Et sur les marchés, l'espoir finit toujours par coûter très cher.", "dur": 11, "q": "crowded chaotic phone notifications red falling chart", "role": "douleur2"},
        ...
        {"t": "Le second type de trader ne dépend plus d'un gourou, ni de sa chance. Il a une méthode claire, une vraie discipline, et un avantage qui tient dans la durée. C'est plus lent, c'est carré, et c'est exactement ça qui finit par marcher.", "dur": 13, "q": "focused confident trader premium desk methodical", "role": "valeur"},
