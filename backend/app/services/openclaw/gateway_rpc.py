...
async def _openclaw_call_once(
    ...
    *,
    ...
    # Only pass ssl= explicitly when using a custom (insecure) context.
    # For standard wss:// connections let websockets auto-select TLS by scheme;
    # passing ssl=None explicitly raises ValueError for wss:// URIs.
