...
const ANGEL_ROSTER: Angel[] = [
  ...
  { id: 8,  name: "Ridwān",          name_ar: "رِضْوَان",        platform: "VIP Welcome Paradise",     manzilah: "Onboarding Mu'min post-Shahādah",          status: "AWAITING_SETUP",  mission: "Welcome flow ABSENT · 10 Privilèges Mu'min à activer (P12c)",              stack: "Resend + Telegram (à câbler)" },
