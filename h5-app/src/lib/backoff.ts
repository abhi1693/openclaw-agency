export type ExponentialBackoffOptions = { baseMs?: number; factor?: number; maxMs?: number; jitter?: number; };
export type ExponentialBackoff = { nextDelayMs: () => number; reset: () => void; attempt: () => number; };
...
export const createExponentialBackoff = (options: ExponentialBackoffOptions = {}): ExponentialBackoff => {
